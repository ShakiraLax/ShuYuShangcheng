package com.sypm.shuyushangcheng.moudle.address;
...
public class MapAddressActivity extends BaseActivity implements LocationSource, AMapLocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView = (MapView) findViewById(R.id.map);//显示地图
        ...
        MyLocationStyle myLocationStyle = new MyLocationStyle();//定位的小图标 默认是蓝点 这里自定义一箭头，其实就是一张图片
        myLocationStyle.myLocationIcon(BitmapDescriptorFactory.fromResource(R.drawable.iconmap));//已更改
